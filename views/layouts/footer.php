        <footer id="imagenNav2">
            <nav class="navbar navbar-dark" >
                ...
                <h4 class="text-white">
                <blockquote class="blockquote mx-auto text-center" id="footer" onclick="square(this.id)"> En caso de dudas, inquietudes o problemas técnicos puede 
                comunicarse con la División de TIC. <br>
                Teléfono: 3187035378 <br>
                Correo electrónico: edisonm@unicauca.edu.co<br> 
